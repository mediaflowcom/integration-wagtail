...
def mfvideo_modal(request):
    ...
    return render_modal_workflow(
        ...
        None,
        {'locale': translation.get_language(), 'trigger': request.GET.get('trigger'), "client_secret": client_secret, "client_id": client_id, "server_key": appSettings.server_key, "server_id": appSettings.server_id}, # html template vars
